...
public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements client.WeatherWebService {
 ...
 */
    ...
    public client.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public client.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            client.WeatherWebServiceSoap12Stub _stub = new client.WeatherWebServiceSoap12Stub(portAddress, this);
    ...
    public client.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public client.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            client.WeatherWebServiceSoap_BindingStub _stub = new client.WeatherWebServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (client.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                client.WeatherWebServiceSoap12Stub _stub = new client.WeatherWebServiceSoap12Stub(new java.net.URL(WeatherWebServiceSoap12_address), this);
                _stub.setPortName(getWeatherWebServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (client.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                client.WeatherWebServiceSoap_BindingStub _stub = new client.WeatherWebServiceSoap_BindingStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
